    ...
    def solve(self):
        ...
        for i_episode in range(1, self.num_episodes + 1):
            ...
            while True:
                ...
                short_memory_states[-1] = state
                short_memory_actions[-1] = action
                # add the discounted rewards to previous samples
                short_memory_rewards += reward * discount
                ...
                if self.n_step > 1:
                    ...
                    short_memory_actions[:-1] = short_memory_actions[1:]
                    short_memory_rewards[:-1] = short_memory_rewards[1:]
                short_memory_rewards[-1] = np.zeros((self.num_agents,))
